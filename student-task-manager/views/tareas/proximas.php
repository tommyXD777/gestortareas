...
<div class="mb-6">
    <div class="flex items-center justify-between">
        <div class="flex items-center">
            ...
            <h2 class="text-2xl font-bold">Próxima Tareas (Próximos 7 días)</h2>
        </div>
...
<?php if (empty($tasks)): ?>
    <div class="bg-white rounded-lg shadow-md p-6 text-center">
        <p class="text-gray-600 mb-4">No tienes ninguna Tarea pendiente para los próximos 7 días.</p>
        <a href="index.php?controller=task&action=add" class="bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 transition duration-300">
            <i class="fas fa-plus mr-2"></i> Agregar una Tarea
        </a>
    </div>
<?php else: ?>
                ...
                <?php foreach ($tasks as $task): ?>
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <?php else: ?>
                                <span class="text-xs text-blue-600">Due in <?php echo $days_left; ?> days</span>
                            <?php endif; ?>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            ...
                            <a href="index.php?controller=task&action=delete&id=<?php echo $task->id; ?>" class="text-red-600 hover:text-red-900" onclick="return confirm('Estás segur@ de eliminar esta Tarea?');">
