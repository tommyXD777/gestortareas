...
<div class="mb-6">
    <div class="flex items-center justify-between">
        <div class="flex items-center">
            ...
            <h2 class="text-2xl font-bold"><?php echo ucfirst($category); ?> Tareas</h2>
        </div>
...
<?php if (empty($tasks)): ?>
    <div class="bg-white rounded-lg shadow-md p-6 text-center">
        <p class="text-gray-600 mb-4">No tienes Ninguna Tarea en la "<?php echo ucfirst($category); ?>" Categoría.</p>
        <a href="index.php?controller=task&action=add" class="bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 transition duration-300">
